...
const initialize = (events, Kubeform, hikaru, setupKubectx = () => {}) => async (kubeformParams, specification, hikaruParams, options = {}) => {
  try {
...
module.exports = (events, Kubeform, hikaru, setupKubectx) => {
  return {
    initialize: initialize(events, Kubeform, hikaru, setupKubectx),
    events
  }
}
